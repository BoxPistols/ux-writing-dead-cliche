...
description: "PR 本文・PR レビューコメント・コミットメッセージ・Slack 文面を、AI 生成の痕跡なしに端的で敬意ある文体で書くための規律。PR 作成、コミット、レビュー投稿、issue 起票、Slack 共有文の作成時に必ず適用する。Triggers: PR作成, プルリクエスト, コミットメッセージ, レビューコメント, issue, Slack共有, 依頼文."
---
